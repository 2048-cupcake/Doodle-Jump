...
function init() {
	...
	function gameOver() {
		...
		if(player.y > height/2 && flag === 0) {
			...
			tweet.href='https://twitter.com/share?url=https://2048-cupcake.blogspot.com/2020/09/doodle-jump.html&text=I just scored ' +score+ ' points in the HTML5 Doodle Jump game!&count=horiztonal&via=1sumitkmr0&related=solitarydesigns';
